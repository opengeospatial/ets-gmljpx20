...
public class StreamUtil {
     ...
     * @return A byte array containing data read from the underlying stream. This might be less than the number of bytes
     *         requested if the end of the stream is reached.
     * @throws IOException
     *             An I/O error occurs. // @throws ObjectDisposedException The stream is closed. // @throws
    ...
    private static byte[] readExactBytes( InputStream s, int count )
            throws Exception {
        byte[] buffer = new byte[count];
        int len = s.read( buffer, 0, count );
        if ( len < count )
     ...
     * @param s
     *            The stream to read.
     * @return A 4-byte signed integer read from the current stream. // @throws EndOfStreamException The end of the
     *         stream is reached. // @throws ObjectDisposedException The stream is closed.
     * @throws IOException
     *             An I/O error occurs.
     */
    public static int readBInt32( InputStream s )
                            throws Exception {
     ...
     * @throws Exception
     *             //@throws EndOfStreamException The end of the stream is reached. //@throws ObjectDisposedException
     *             The stream is closed.
     * @throws IOException
     *             An I/O error occurs.
     */
    public static long readBInt64( InputStream s )
                            throws Exception {
     ...
     *             An I/O error occurs.
     */
    public static short readBUInt16( InputStream s )
                            throws Exception {
     ...
     *             An I/O error occurs.
     */
    public static long readBUInt32( InputStream s )
                            throws Exception {
        byte[] buffer = readExactBytes( s, 4 );
     ...
     *             An I/O error occurs.
     */
    public static long readBUInt64( InputStream s )
                            throws Exception {
        byte[] buffer = readExactBytes( s, 8 );
        return BitConverter.toInt64( buffer, 0 );
    }
