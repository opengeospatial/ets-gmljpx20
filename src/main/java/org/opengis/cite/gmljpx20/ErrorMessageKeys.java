...
public class ErrorMessageKeys {
    ...
    public static final String AUX_FILETYPE_NOT_FOUND = "AuxFileTypeNotFound";
    ...
    public static final String GMLJP2_GMLCOV_NIL_VALUES_BY_REF = "gmljp2-gmlcov-nil-values-byref";
    ...
    public static final String GMLJP2_FILE_EXTERNAL_REF = "gmljp2-file-external-ref";
    public static final String GMLJP2_INTERNAL_REFERENCES = "gmljp2-internal-ref";
    public static final String GMLJP2_INTERNAL_REF = "gmljp2-internal-ref";
