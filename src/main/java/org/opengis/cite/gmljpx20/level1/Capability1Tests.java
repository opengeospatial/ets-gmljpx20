package org.opengis.cite.gmljpx20.level1;

import java.io.IOException;
import java.net.URL;
import javax.xml.transform.Source;
import javax.xml.transform.dom.DOMSource;
import org.opengis.cite.gmljpx20.CommonFixture;
...
public class Capability1Tests extends CommonFixture {
     ...
     * {@link org.opengis.cite.gmljpx20.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/gmljpx20/rnc/atom.rnc");
