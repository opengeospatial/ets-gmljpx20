...
in JPEG 2000 (GMLJP2) Encoding Standard Part 1_ http://docs.opengeospatial.org/is/08-085r4/08-085r4.html[OGC 08-085r4].
...
The test suite uses the Geospatial Data Abstraction Library (http://www.gdal.org/[GDAL])
